...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `estatus` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'false (inactivo/eliminado), true(activo es default)'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Tabla para almacenar a los usuarios del sistema';
